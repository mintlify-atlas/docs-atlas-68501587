---
title: "AnythingLLM Developer API Reference"
...
| `GET` | `/v1/workspace/{slug}/chats` | Retrieve chat history |
...
| `GET` | `/v1/admin/preferences` | Get system preferences |
...
| `GET` | `/v1/embed/{embedUuid}/chats` | List sessions for an embed |
