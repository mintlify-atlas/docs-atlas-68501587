...
<ResponseField name="sources" type="array">Array of source document chunks used to generate the answer.</ResponseField>
...
<ResponseField name="sources" type="array">Populated only in the final chunk (`close: true`).</ResponseField>
