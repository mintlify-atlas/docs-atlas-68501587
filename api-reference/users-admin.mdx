---
title: "User Management and Admin API Endpoints"
sidebarTitle: "Users & Admin"
description: "REST API for managing users, invites, workspace user access, and admin preferences in multi-user AnythingLLM instances."
---
...
Update instance-wide multi-user preferences. Only the keys you supply will be changed.
...
<ResponseField name="error" type="string | null">`null` on success or an error message.</ResponseField>
<ResponseField name="users" type="array">
  Updated list of users with access, each including `userId`, `username`, and `role`.
</ResponseField>
