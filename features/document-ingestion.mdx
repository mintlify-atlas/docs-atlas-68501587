...
<Steps>
  ...
  <Step title="Parse & Convert">
    ...
    - Images (PNG, JPG, WEBP) → Tesseract OCR
...
For image-based PDFs and standalone image files (PNG, JPG, WEBP), AnythingLLM uses [Tesseract.js](https://github.com/naptha/tesseract.js) to extract text automatically.
