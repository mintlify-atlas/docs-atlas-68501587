...
description: "AnythingLLM supports multimodal LLMs for image understanding. Attach images to chats and use vision-capable models from OpenAI, Anthropic, Gemini, and others."
---
...
<Tabs>
  ...
  <Tab title="Configuration">
    ...
    Audio files uploaded for transcription (`.mp3`, `.wav`, `.mp4`, `.m4a`, `.ogg`, `.opus`, `.webm`) are converted to WAV format internally before being sent to the STT provider.
  </Tab>
</Tabs>
