...
description: "Install AnythingLLM via Docker, connect an LLM provider, upload a document, and send your first chat. Works with Ollama, OpenAI, and 35+ providers."
---
