---
title: "MCP Server Compatibility and Configuration in AnythingLLM"
sidebarTitle: "MCP Compatibility"
description: "AnythingLLM supports the Model Context Protocol (MCP). Connect any MCP server to expose its tools to agents and expand capabilities without custom code."
---
