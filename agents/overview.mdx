...
description: "AnythingLLM agents extend your LLM with real-world tools: web browsing, file creation, SQL queries, code execution, calendar access, and custom MCP servers."
---
...
<CardGroup cols={2}>
  ...
  >
    Web browsing, SQL, file creation, Gmail, Google Calendar, Outlook, charts, and more.
  </Card>
  <Card
    title="Custom Agents"
    icon="robot"
